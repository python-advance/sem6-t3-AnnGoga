...
if __name__ == "__main__":
    ...
    print(f'Получение валюты из кэша: {X.get_currency_from_cache("R01239")}')
    print(f'Добавление новой валюты: {X.get_new_currency("R01375")}')
    print(f'Текущие курсы: {X.rates}')
    print(f'Обновление всех курсов: {X.update()}')
    print('Ожидайте. Система несколько раз проверит обновления и уведомит вас о результатах в течении нескольких минут.')
    time.sleep(180)
    print('', X.check())
    time.sleep(120)
